...
<div class="container">
    ...
    <form action="MyController" method="get">
        ...
        <h4>${errorValidator}</h4>
        <h4>${errorMessage}</h4>
    </form>
</div>

<a href="${pageContext.request.contextPath}/WEB-INF/welcome.jsp">${back_to_main}</a>
...
<a href="MyController?command=GO_TO_WELCOME_PAGE">${back_to_main}</a>
