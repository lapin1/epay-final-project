...
<head>
    ...
    <link href="./css/header.css?v=1.1" rel="stylesheet" type="text/css">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form action="MyController" method="post">
                            ...
                            ${sum}:
                            <input type="number" size="4" step="0.1" name="sum" value="" required/>
                            <br>
        ...
        <div class="tab2">
            <form action="MyController" method="post">
                <div class="recipient">
                    ...
                    <div>
                        <label>${sum}:</label>
                        <input type="number" step="0.1" name="sum" value=""/>
                    </div>
                </div>
