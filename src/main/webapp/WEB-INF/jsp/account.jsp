...
<div class="tabs">
    ...
    <div id="content-3">
        ...
        <c:forEach var="card" varStatus="countOfCards" items="${cards}">
            <div class="card-div">
                ...
                <a href="MyController?command=GO_TO_SELECTED_ACCOUNT&id=<c:out value="${card.id}"/>">${remove_card}</a>
            </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form action="MyController" method="post">
                            ...
                            ${card_number_label}:
                            <input type="text" maxlength="16" name="cardNumber" value=""/>
                            <br>
                            ${exp_date}
                            <input type="text" maxlength="2" size="3" name="month" value=""/> / <input type="text"
                                                                                                       maxlength="4"
                                                                                                       size="6"
                                                                                                       name="year"
                                                                                                       value=""/>
                            <br>
                            cvv:
                            <input type="text" maxlength="3" size="4" name="cvv" value=""/>
                            <br>
                            <div class="modal-footer">
    ...
    <div id="content-4">
        ...
        <label class="btn" for="modal-2">Открыть</label>
