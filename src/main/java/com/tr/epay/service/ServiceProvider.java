...
public final class ServiceProvider {
    ...
    private PaymentService transactionService = new SQLPaymentService();
    ...
    public PaymentService getTransactionService() {
        return transactionService;
    }

    public void setTransactionService(PaymentService transactionService) {
