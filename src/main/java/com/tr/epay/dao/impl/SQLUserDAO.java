...
public class SQLUserDAO implements UserDAO {
    ...
    public boolean authorization(String login, String password) throws DAOException {
        ...
        try {
            ...
            log.error(LoggerMessage.ERROR_SELECTING_USER + login, ex);
    ...
    public void registration(User user, UserInfo userInfo) throws DAOException, SQLException {
        ...
        try {
            ...
            log.error(LoggerMessage.ERROR_INSERTING_USER + user.getLogin(), ex);
            throw new DAOException(ErrorMessage.ERROR_WITH_DATABASE, ex);
    ...
    public int getIdOfAuthorizedUser(String login) throws DAOException {
        ...
        try {
            ...
            log.error(LoggerMessage.ERROR_GETTING_ID_USER + login, ex);
            throw new DAOException(ErrorMessage.ERROR_WITH_DATABASE, ex);
    ...
    public String getRoleOfUserById(int userId) throws DAOException {
        ...
        try {
            ...
            log.error(LoggerMessage.ERROR_GETTING_ROLE_OF_USER + userId, ex);
            throw new DAOException(ErrorMessage.ERROR_WITH_DATABASE, ex);
    ...
    public String getNameOfUser(int userId) throws DAOException {
        ...
        try {
            ...
            log.error(LoggerMessage.ERROR_GETTING_USER_NAME + userId, ex);
            throw new DAOException(ErrorMessage.ERROR_WITH_DATABASE, ex);
    ...
    public List<User> viewAllUsers() throws DAOException{
        ...
        try {
            ...
            log.error(LoggerMessage.ERROR_GETTING_USERS, ex);
            throw new DAOException(ErrorMessage.ERROR_WITH_DATABASE, ex);
        }finally {
            if (connection != null) {
    ...
    public UserInfo showUserInformationById(int id) throws DAOException {
        ...
        try {
            ...
            log.error(LoggerMessage.ERROR_GETTING_USER_INFORMATION + id, ex);
            throw new DAOException(ErrorMessage.ERROR_WITH_DATABASE, ex);
        }finally {
            if (connection != null) {
    ...
    public boolean updateUserInformation(UserInfo userInfo) throws DAOException {
        ...
        try {
            ...
            log.error(LoggerMessage.ERROR_UPDATING_USER_INFORMATION + userInfo.getId(), ex);
            throw new DAOException(ErrorMessage.ERROR_WITH_DATABASE, ex);
        }finally {
            if(connection != null){
